...
fun AmazonJsonFake.createTable(tables: Storage<TableDefinition>) = route<CreateTable> {
    ...
    tables[it.TableName.value] = TableDefinition(tableDescription, mutableListOf())
