...
open class AttrLensSpec<OUT>(
    ...
    override fun optional(name: String, description: String?): AttrLens<OUT?> {
    ...
    override fun required(name: String, description: String?): AttrLens<OUT> {
        val getLens = get(name)
        val setLens = set(name)
        return AttrLens(
            dataType,
