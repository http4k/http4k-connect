...
import org.http4k.connect.azure.Quality
import org.http4k.connect.azure.Style
...
data class GenerateImage(
    ...
    ) : NonNullAutoMarshalledAction<GeneratedImage>(kClass(), AzureAIMoshi), AzureAIAction<GeneratedImage> {

    constructor(prompt: String, size: Size) : this(prompt, size, url, 1)

    override fun toRequest() = Request(POST, "/v1/images/generations")
        .with(AzureAIMoshi.autoBody<GenerateImage>().toLens() of this)
}
