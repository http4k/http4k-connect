...
[comment]: <> (<img alt="jcenter free" src="https://img.shields.io/badge/JCenter%20free-%3Ev2.15.0.1-success">)
...
dependencies {
    ...
    implementation platform("org.http4k:http4k-connect-bom:2.15.0.1")
